...
All display text can use HTML elements (`div`, `span` etc.) and (**except getTitle, getDisplay and getTooltip for grids**) Vue features (the text is automatically inside an span element). **Note**: Do not make displays functions because it will not work. Use Vue features like text interpolation instead.
...
- [Decimals](Decimals.md): How to use Decimals.
...
- [Number formatting](numberFormatting.md): How to format numbers to make them look nicely.
- [Updating TMI](tutorials/updating-tmi.md): Using Github Desktop to update your mod's version of TMI.
- [save bank](saveBank.md): A save bank so people can get an save easily if they lose their save.
- [modes](modes.md): How to create modes that player can enter to change the game in some way.
- [news ticker](newsTicker.md): Basically funny messages displayed at the top that goes from right to left.
- [features](features.md): Display progress to next feature.
- [Other Things](other.md): Other neat features that TMI has that don't merit their own page.
...
- [Microtabs](microtabs.md): "microtab" components that you can put inside the tabs.
...
- [custom components](components.md): How to make your own Vue components and use them in tabFornat.
