...
- name: Name of the challenge. Can use basic HTML and vue.

- challengeDescription: A description of what makes the challenge a challenge. *You will need to implement these elsewhere.*. Can use basic HTML and vue.

- goalDescription: A description of the win condition for the challenge. Can use basic HTML and vue. 
...
- rewardDescription: A description of the reward's effect. *You will also have to implement the effect where it is applied.*. Can use basic HTML and vue.
...
- rewardDisplay: **optional**. A display of the current effects of the reward with formatting.

- fullDisplay: **OVERRIDE**. Overrides the other displays and descriptions, and lets you set the full text for the challenge. Can use basic HTML and vur.
