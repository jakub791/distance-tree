...
Microtabs are smaller areas of the tab . You can also embed layers inside of microtabs.

Microtabs are defined in the "microtabs" feature. Each entry is a group of tabs which will appear in a microtabs component. The first set, "stuff", has 2 tabs, and the second, "otherStuff", has none.
...
microtabs use these features features:
